...
public class Rotate3DCubeAnimation extends Animation {  
    ...
    public Rotate3DCubeAnimation(float fromDegree, float toDegree)  
    {  
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {  
        ...
        {  
            ...
            //这个值就如同照相机与画面之间距离的增量。  
            mCamera.translate(0, 0, halfHeight);  
...
//          mCamera.translate(0, halfWidth, 0);  
            ...
            //另一方面，这句代码产生了一个随着degree变化的左下角值，这个值与画面的错切效果相关（x轴缩放与垂直错切相结合，就是绕Y轴旋转效果）  
