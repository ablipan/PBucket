			...
			public Void runInBackground() {
				synchronized (Logger.class) {
					...
					String filename = logFilePath+
							DateUtils.millisToStringFilename(DateUtils.getCurrentMillis(),DateUtils.DEF_MONTH_FMT_2)
							+ ".log";
					...
					try {
						...
						String formatMsg = DateUtils.millisToDateString(System
								.currentTimeMillis())
								+ "\r\n["
								+ priority
								+ "]["
