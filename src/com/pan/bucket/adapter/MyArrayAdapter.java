...
public class MyArrayAdapter<T> extends BaseAdapter implements Filterable {
     ...
     */
    public static MyArrayAdapter<CharSequence> createFromResource(Context context,
    ...
    private class ArrayFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (prefix == null || prefix.length() == 0) {
                ...
                String prefixString = prefix.toString().toLowerCase(Locale.CHINA);
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    final String valueText = value.toString().toLowerCase(Locale.CHINA);
